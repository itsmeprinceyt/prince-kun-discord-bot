import { EMOTES } from "../../uuid/Emotes";
const GC: string = EMOTES[0].roleId;
const YC: string = EMOTES[1].roleId;
const RC: string = EMOTES[2].roleId;
const BC: string = EMOTES[3].roleId;
const PC: string = EMOTES[4].roleId;

export const ItsMePrinceRules: string =
        `__**Rules**__ (If you don’t want to read, watch this [YouTube video](https://www.youtube.com/watch?v=fLheG3qV3xU))\n` +
